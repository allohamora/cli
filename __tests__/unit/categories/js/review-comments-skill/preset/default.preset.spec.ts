...
describe('review-comments-skill default.preset', () => {
  describe('content', () => {
    it('matches the exact expected review-comments skill markdown', () => {
      expect(content).toBe(expectedContent);
    });

    it('keeps the gh api reply command as separate, backslash-continued lines', () => {
    ...
    it('has a review-comments frontmatter name', () => {
