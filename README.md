...
| **eslint**           | setups [eslint](https://github.com/eslint/eslint) with a config and lint scripts                                                                                                                 | `prettier`, `jest`                                 |
...
| **npmrc**            | creates a .npmrc file with the default npm config                                                                                                                                                |                                                    |
| **nvmrc**            | creates a .nvmrc file from the current node version                                                                                                                                              |                                                    |
| **check-workflow**   | setups a github check workflow that runs available lint, format, typecheck, and build checks on push                                                                                             | `eslint`, `prettier`, `nvmrc`                      |
